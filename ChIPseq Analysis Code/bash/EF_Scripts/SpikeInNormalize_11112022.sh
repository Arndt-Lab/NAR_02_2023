...
#COMBINE ALL INFO
join -1 1 -2 1 ${dir}/Scripts/ef_sample_info_11112022.txt ${scer_stats}/names_and_reads.txt > ${dir}/Scripts/updated_ef_sample_info_11112022.tmp
join -1 1 -2 1 ${dir}/Scripts/updated_ef_sample_info_11112022.tmp ${spike_in_stats}/names_and_reads.txt > ${dir}/Scripts/updated_ef_sample_info_11112022.txt


#CALCULATE NORMALIZATION FACTOR
awk ' $4=="IP" {print $1 "\t" $2 "\t" $3 "\t" $4 "\t" $5 "\t" $6 "\t" $7 "\t" $2 "_" $3  "_" $5}' ${dir}/Scripts/updated_ef_sample_info_11112022.txt > ${dir}/Scripts/IP.tmp
awk ' $4=="input" {print $1 "\t" $2 "\t" $3 "\t" $4 "\t" $5 "\t" $6 "\t" $7 "\t" $2 "_" $3  "_" $5}' ${dir}/Scripts/updated_ef_sample_info_11112022.txt > ${dir}/Scripts/Input.tmp
join -1 8 -2 8 ${dir}/Scripts/IP.tmp ${dir}/Scripts/Input.tmp > ${dir}/Scripts/NormParalleleInfo.tmp
...
rm ${dir}/Scripts/updated_ef_sample_info_11112022.tmp
rm ${dir}/Scripts/IP.tmp ${dir}/Scripts/Input.tmp
