...
fCount1 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Arndt_Lab_Consulting/ChIPseq_Redo_Spt6_AID_112022/DESeq_Analysis_ChIPseq_Redo_11192022/bams/SN114_S1_nodups.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount2 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Arndt_Lab_Consulting/ChIPseq_Redo_Spt6_AID_112022/DESeq_Analysis_ChIPseq_Redo_11192022/bams/SN115_S2_nodups.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount3 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Arndt_Lab_Consulting/ChIPseq_Redo_Spt6_AID_112022/DESeq_Analysis_ChIPseq_Redo_11192022/bams/SN116_S3_nodups.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount4 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Arndt_Lab_Consulting/ChIPseq_Redo_Spt6_AID_112022/DESeq_Analysis_ChIPseq_Redo_11192022/bams/SN117_S4_nodups.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
...
#dds <- DESeq(dds)
resultsNames(dds)
sizeFactors(dds) <- c(1/0.0216377, 1/0.0194364, 1/0.0202532, 1/0.0185512)
